...
class PyiCloudService(object):
    ...
    def __init__(
        ...
        # <class 'pyicloud.base.PyiCloudService'>
        print(type(self))
        print("***** client_id *****")
    ...
    def drive(self):
        ...
        print("***** base/drive prep *****")
        self.params["clientId"] = self.session_data.get("client_id")
        print("***** base/drive prep *****")
        if not self._drive:
            print("Not self._drive")
        ...
        print("self.params")
        print(self.params)
        print("self.session_data.get(client_id)")
        print(self.session_data.get("client_id"))
        print("type(self._drive)")
        print(type(self._drive)) # <class 'pyicloud.services.drive.DriveService'>
        print("dir(self._drive)")
        print(dir(self._drive)) # <=== This has the create_folders method
        print("***** base/drive *****")
        return self._drive
